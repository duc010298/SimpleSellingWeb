        ...
        <div class="container">
            <div class="jumbotron">
                ...
                <form onsubmit="return submitfunction()">
                    ...
                    <div class="form-group">
                        <label for="price">Nhập giá tiền sản phẩm:</label>
                        <input type="text" class="form-control" id="price" name="price" required>
                    </div>
                    <div class="form-group">
                        <label for="picture">Nhập đường dẫn ảnh của sản phẩm:</label>
                        <input type="text" class="form-control" id="picture" name="picture" required>
                    </div>
                    <div class="form-group">
                        <label for="description">Nhập miêu tả sản phẩm:</label>
                        <textarea  type="text" class="form-control" rows="7" id="description" name="description" required></textarea>
                    </div>
                    <div class="form-group">
